...
},{"./params":9,"./vval":33}],9:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./common":14}],12:[function(require,module,exports){
"use strict";
...
exports.regex = regex;
},{"../withParams":34}],15:[function(require,module,exports){
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./alpha":10,"./alphaNum":11,"./and":12,"./between":13,"./common":14,"./decimal":15,"./email":16,"./integer":18,"./ipAddress":19,"./macAddress":20,"./maxLength":21,"./maxValue":22,"./minLength":23,"./minValue":24,"./not":25,"./numeric":26,"./or":27,"./required":28,"./requiredIf":29,"./requiredUnless":30,"./sameAs":31,"./url":32}],18:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./common":14}],32:[function(require,module,exports){
"use strict";
...
exports.default = _default;
},{"./common":14}],33:[function(require,module,exports){
"use strict";
...
},{"./params":9,"./withParamsBrowser":35,"_process":2}],35:[function(require,module,exports){
(function (global){
"use strict";
...
var _registrationForm = _interopRequireDefault(require("./registrationForm.vue"));

// *** Importing Vue-components ***
// *** Main Vue development configuration ***
_vue.default.config.productionTip = false;
_vue.default.config.devtools = true; // *** Connecting tools ***

_vue.default.use(_vuelidate.default); // *** Vue instance ***


new _vue.default({
  render: function render(h) {
    return h(_registrationForm.default);
  }
}).$mount('#registrationForm');

},{"./registrationForm.vue":37,"@babel/runtime/helpers/interopRequireDefault":1,"vue":6,"vuelidate":8}],37:[function(require,module,exports){
;(function(){
//
//
//
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{staticClass:"registration-form",on:{"submit":function($event){$event.preventDefault();return _vm.onSubmit($event)}}},[_c('fieldset',{staticClass:"registration-form__data-field data-fieldset data-fieldset--personal-data"},[_vm._m(0),_vm._v(" "),_c('ul',{staticClass:"data-fieldset__data-list list-of-data"},[_c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"surname"}},[_vm._v("Фамилия:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model.trim",value:(_vm.$v.surname.$model),expression:"$v.surname.$model",modifiers:{"trim":true}}],staticClass:"list-of-data__input",class:{invalid: (_vm.$v.surname.$dirty && !_vm.$v.surname.required)},attrs:{"type":"text","name":"client-surname","id":"surname","placeholder":"Иванов"},domProps:{"value":(_vm.$v.surname.$model)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$v.surname, "$model", $event.target.value.trim())},"blur":function($event){return _vm.$forceUpdate()}}}),_vm._v(" "),(_vm.$v.surname.$dirty && !_vm.$v.surname.required)?_c('span',{staticClass:"list-of-data__invalid-feedback"},[_vm._v("Необходимо ввести Фамилию!")]):_vm._e()]),_vm._v(" "),_c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"name"}},[_vm._v("Имя:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model.trim",value:(_vm.$v.name.$model),expression:"$v.name.$model",modifiers:{"trim":true}}],staticClass:"list-of-data__input",class:{invalid: (_vm.$v.name.$dirty && !_vm.$v.name.required)},attrs:{"type":"text","name":"client-name","id":"name","placeholder":"Иван"},domProps:{"value":(_vm.$v.name.$model)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$v.name, "$model", $event.target.value.trim())},"blur":function($event){return _vm.$forceUpdate()}}}),_vm._v(" "),(_vm.$v.name.$dirty && !_vm.$v.name.required)?_c('span',{staticClass:"list-of-data__invalid-feedback"},[_vm._v("Необходимо ввести Имя!")]):_vm._e()]),_vm._v(" "),_vm._m(1),_vm._v(" "),_c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"birthday"}},[_vm._v("Дата рождения:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model.trim",value:(_vm.$v.birthday.$model),expression:"$v.birthday.$model",modifiers:{"trim":true}}],staticClass:"list-of-data__input",class:{invalid: (_vm.$v.birthday.$dirty && !_vm.$v.birthday.required)},attrs:{"type":"date","name":"client-birthday","id":"birthday"},domProps:{"value":(_vm.$v.birthday.$model)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$v.birthday, "$model", $event.target.value.trim())},"blur":function($event){return _vm.$forceUpdate()}}}),_vm._v(" "),(_vm.$v.birthday.$dirty && !_vm.$v.birthday.required)?_c('span',{staticClass:"list-of-data__invalid-feedback"},[_vm._v("Укажите, пожалуйста, дату рождения.")]):_vm._e()]),_vm._v(" "),_c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"phone"}},[_vm._v("Номер телефона:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model.trim",value:(_vm.$v.phone.$model),expression:"$v.phone.$model",modifiers:{"trim":true}}],staticClass:"list-of-data__input",class:{invalid: (_vm.$v.phone.$dirty && !_vm.$v.phone.required || _vm.$v.phone.$dirty && !_vm.$v.phone.validFormat)},attrs:{"type":"tel","name":"client-phone","id":"phone","placeholder":"7 (999) 123-45-67","minLength":"11","maxlength":"17"},domProps:{"value":(_vm.$v.phone.$model)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$v.phone, "$model", $event.target.value.trim())},"blur":function($event){return _vm.$forceUpdate()}}}),_vm._v(" "),(_vm.$v.phone.$dirty && !_vm.$v.phone.validFormat)?_c('span',{staticClass:"list-of-data__invalid-feedback"},[_vm._v("Введённое значение не соответствует паттерну ввода!")]):_vm._e()]),_vm._v(" "),_vm._m(2),_vm._v(" "),_c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"category"}},[_vm._v("Группа клиентов:")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.$v.сategories.$model),expression:"$v.сategories.$model"}],class:{invalid: (_vm.$v.сategories.$dirty && !_vm.$v.сategories.required)},attrs:{"name":"client-category","id":"category","multiple":""},on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.$set(_vm.$v.сategories, "$model", $event.target.multiple ? $$selectedVal : $$selectedVal[0])}}},_vm._l((_vm.availableCategories),function(category){return _c('option',{domProps:{"value":category}},[_vm._v(_vm._s(category))])}),0),_vm._v(" "),(_vm.$v.сategories.$dirty && !_vm.$v.сategories.required)?_c('span',{staticClass:"list-of-data__invalid-feedback"},[_vm._v("Пожалуйста, выберите категорию.")]):_vm._e()]),_vm._v(" "),_c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"doctor"}},[_vm._v("Лечащий врач:")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.$v.selectedDoctor.$model),expression:"$v.selectedDoctor.$model"}],attrs:{"name":"attending-doctor","id":"doctor"},on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.$set(_vm.$v.selectedDoctor, "$model", $event.target.multiple ? $$selectedVal : $$selectedVal[0])}}},_vm._l((_vm.availableDoctors),function(doctor){return _c('option',{domProps:{"value":doctor}},[_vm._v(_vm._s(doctor))])}),0)]),_vm._v(" "),_vm._m(3)])]),_vm._v(" "),_c('fieldset',{staticClass:"registration-form__data-field data-fieldset data-fieldset--address"},[_vm._m(4),_vm._v(" "),_c('ul',{staticClass:"data-fieldset__data-list list-of-data"},[_vm._m(5),_vm._v(" "),_vm._m(6),_vm._v(" "),_vm._m(7),_vm._v(" "),_c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"city"}},[_vm._v("Город:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model.trim",value:(_vm.$v.city.$model),expression:"$v.city.$model",modifiers:{"trim":true}}],staticClass:"list-of-data__input",class:{invalid: (_vm.$v.city.$dirty && !_vm.$v.city.required)},attrs:{"type":"text","name":"client-city","id":"city","placeholder":"Санкт-Петербург"},domProps:{"value":(_vm.$v.city.$model)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$v.city, "$model", $event.target.value.trim())},"blur":function($event){return _vm.$forceUpdate()}}}),_vm._v(" "),(_vm.$v.city.$dirty && !_vm.$v.city.required)?_c('span',{staticClass:"list-of-data__invalid-feedback"},[_vm._v("Укажите, пожалуйста, город, в котором проживаете.")]):_vm._e()]),_vm._v(" "),_vm._m(8),_vm._v(" "),_vm._m(9)])]),_vm._v(" "),_c('fieldset',{staticClass:"registration-form__data-field data-fieldset data-fieldset--document"},[_vm._m(10),_vm._v(" "),_c('ul',{staticClass:"data-fieldset__data-list list-of-data"},[_c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"document"}},[_vm._v("Тип документа:")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.$v.selectedDocument.$model),expression:"$v.selectedDocument.$model"}],class:{invalid: (_vm.$v.selectedDocument.$dirty && !_vm.$v.selectedDocument.required)},attrs:{"name":"client-document","id":"document"},on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.$set(_vm.$v.selectedDocument, "$model", $event.target.multiple ? $$selectedVal : $$selectedVal[0])}}},_vm._l((_vm.availableDocuments),function(identityDoc){return _c('option',{domProps:{"value":identityDoc}},[_vm._v(_vm._s(identityDoc))])}),0),_vm._v(" "),(_vm.$v.selectedDocument.$dirty && !_vm.$v.selectedDocument.required)?_c('span',{staticClass:"list-of-data__invalid-feedback"},[_vm._v("Выберите тип документа для регистрации.")]):_vm._e()]),_vm._v(" "),_vm._m(11),_vm._v(" "),_vm._m(12),_vm._v(" "),_vm._m(13),_vm._v(" "),_c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"dateOfIssue"}},[_vm._v("Дата выдачи:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.$v.dateOfIssue.$model),expression:"$v.dateOfIssue.$model"}],staticClass:"list-of-data__input",class:{invalid: (_vm.$v.dateOfIssue.$dirty && !_vm.$v.dateOfIssue.required)},attrs:{"type":"date","name":"client-passport","id":"dateOfIssue"},domProps:{"value":(_vm.$v.dateOfIssue.$model)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.$v.dateOfIssue, "$model", $event.target.value)}}}),_vm._v(" "),(_vm.$v.dateOfIssue.$dirty && !_vm.$v.dateOfIssue.required)?_c('span',{staticClass:"list-of-data__invalid-feedback"},[_vm._v("Необходимо указать дату выдачи документа.")]):_vm._e()])])]),_vm._v(" "),_c('button',{staticClass:"registration-form__submit-button",attrs:{"type":"submit"}},[_vm._v("Зарегистрироваться")]),_vm._v(" "),_c('div',{staticClass:"modal modal--overlay"}),_vm._v(" "),_c('div',{staticClass:"modal modal--valid-feedback"},[_c('p',{staticClass:"modal__valid-feedback-message"},[_vm._v("Регистрация прошла успешно!")]),_vm._v(" "),_c('div',{staticClass:"modal__close-button-wrapper"},[_c('button',{staticClass:"modal__close-button",attrs:{"type":"button","aria-label":"Закрыть модальное окно"},on:{"click":function($event){$event.preventDefault();return _vm.onModalClose($event)}}})])])])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"data-fieldset__heading-wrapper"},[_c('legend',{staticClass:"data-fieldset__heading"},[_vm._v("Личные данные")])])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"patronymic"}},[_vm._v("Отчество:")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input",attrs:{"type":"text","name":"client-patronymic","id":"patronymic","placeholder":"Иванович"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item list-of-data__item--gender"},[_c('p',{staticClass:"list-of-data__label list-of-data__label--gender"},[_vm._v("Пол:")]),_vm._v(" "),_c('div',{staticClass:"list-of-data__gender-wrapper"},[_c('input',{staticClass:"list-of-data__input list-of-data__input--gender",attrs:{"type":"radio","name":"client-gender","id":"female","checked":""}}),_vm._v(" "),_c('label',{staticClass:"list-of-data__gender-name",attrs:{"for":"female"}},[_vm._v("Ж")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input list-of-data__input--gender",attrs:{"type":"radio","name":"client-gender","id":"male"}}),_vm._v(" "),_c('label',{staticClass:"list-of-data__gender-name",attrs:{"for":"male"}},[_vm._v("М")])])])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item list-of-data__item--message"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"message"}},[_vm._v("Не отправлять СМС")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input list-of-data__input--message",attrs:{"type":"checkbox","name":"client-message","id":"message","checked":""}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"data-fieldset__heading-wrapper"},[_c('legend',{staticClass:"data-fieldset__heading"},[_vm._v("Адрес")])])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"postcode"}},[_vm._v("Индекс:")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input",attrs:{"type":"number","name":"client-postcode","id":"postcode","placeholder":"012345","minlength":"0","maxlength":"6"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"country"}},[_vm._v("Страна:")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input",attrs:{"type":"text","name":"client-country","id":"country","placeholder":"Россия"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"region"}},[_vm._v("Область:")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input",attrs:{"type":"text","name":"client-region","id":"region","placeholder":"Ленинградская"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"street"}},[_vm._v("Улица:")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input",attrs:{"type":"text","name":"client-street","id":"street","placeholder":"Введите название улицы..."}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"housenumber"}},[_vm._v("Дом:")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input",attrs:{"type":"number","name":"client-housenumber","id":"housenumber","placeholder":"Введите номер дома..."}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"data-fieldset__heading-wrapper"},[_c('legend',{staticClass:"data-fieldset__heading"},[_vm._v("Паспорт")])])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"passportSeries"}},[_vm._v("Серия:")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input",attrs:{"type":"number","name":"client-passport","id":"passportSeries","placeholder":"01 23","minlength":"0","maxlength":"5"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"passportNumber"}},[_vm._v("Номер:")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input",attrs:{"type":"number","name":"client-passport","id":"passportNumber","placeholder":"012345","minlength":"0","maxlength":"6"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"list-of-data__item"},[_c('label',{staticClass:"list-of-data__label",attrs:{"for":"placeOfIssue"}},[_vm._v("Кем выдан:")]),_vm._v(" "),_c('input',{staticClass:"list-of-data__input",attrs:{"type":"text","name":"client-passport","id":"placeOfIssue","placeholder":"Полное название государственной организации, выдавшей документ"}})])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-37c8c024", __vue__options__)
  } else {
    hotAPI.reload("data-v-37c8c024", __vue__options__)
  }
})()}
},{"../../node_modules/vuelidate/lib/validators":17,"vue":6,"vue-hot-reload-api":4}]},{},[36]);
